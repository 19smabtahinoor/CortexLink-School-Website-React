                        ...
                        <div className="col-span-1 order-2 lg:order-1 xl:order-1 2xl:order-1">
                            ...
                            <div>
                                ...
                                <NavLink to="/forgot-password">
                                    <h5 className="text-center text-blue-700 text-decoration-underline">Forgot Password ?</h5>
                                </NavLink>
                            </div>
                        ...
                        <div className="col-span-1 order-1 lg:order-2 xl:order-2 2xl:order-2 bg-blue-900 h-screen">
                            <div className="flex flex-col lg:flex-row xl:flex-row 2xl:flex-row justify-center items-center h-screen">
                                <div className="flex flex-col relative -ml-10 lg:ml-0 xl:ml-0 2xl:-ml-10">
                                    <NavLink to="/login" activeClassName="bg-white text-white font-semibold px-7 py-3 rounded-tr-full rounded-br-full w-full my-3 border border-white text-blue-900">
                                        Login
                                    </NavLink>
                                    <NavLink to="/signup">
                                        <button className=" text-white font-semibold px-8 py-3 rounded-tr-full rounded-br-full w-full my-3 border border-white">Signup </button>
                                    </NavLink>
                                </div>

                                <div>
                                    <img src="../../assets/login.png" alt="signup page" width="400px" />
                                </div>
                            </div>
                        </div>
                    </div>
